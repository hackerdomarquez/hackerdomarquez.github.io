...
.custom-container {
    ...
    text-transform: uppercase;
    transition: all 0.2s ease-in-out;
    box-shadow: 0 0 10px rgb(255 0 0 / 50%), 0 0 20px rgb(255 0 0 / 30%);
    position: relative;
    overflow: hidden;
}
...
iframe {
  ...
  touch-action: none; /* Impede interações indesejadas */
}
        ...
        <div class="custom-container">
            ...
            <div class="register-form mt-4">
                ...
                <form id="loginForm">
                    ...
                    <button class="btn btn-primary1 w-100" type="button" onclick="login('https://ricobet.net.br/yjeeeviwq')" style="height: 155px;">
